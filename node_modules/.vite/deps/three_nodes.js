...
var PassNode = class _PassNode extends TempNode_default {
  ...
  getDepthNode() {
    if (this._depthNode === null) {
      ...
      this._depthNode = viewZToOrthographicDepth(perspectiveDepthToViewZ(this._depthTextureNode, cameraNear2, cameraFar2), cameraNear2, cameraFar2);
    }
